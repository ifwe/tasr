...
1. Fork TASR's GitHub repository.  To fork the repo, click the
[fork button](http://github.com/ifwe/tasr/fork) on the
...
to the master branch of the TASR repository.
