...
class TestTASRClientObject(TestTASRAppClient):
    ...
    def obj_register_schema_skeleton(self, schema_str):
        '''TASRClient.register_schema() - skeleton test'''
    ...
    def test_obj_reg_fail_on_invalid_schema(self):
        '''TASRClient.register_schema() - fail on invalid schema'''
        try:
    ...
    def test_obj_reg_and_rereg(self):
        '''TASRClient.register_schema() - multi calls, same schema'''
    ...
    def test_obj_reg_and_get_non_existent_version(self):
        '''TASRClient.get_schema_for_topic() - bad version'''
        reg_rs = self.obj_register_schema_skeleton(self.schema_str)
    ...
    def test_obj_reg_50_and_get_by_version(self):
        '''TASRClient.get_schema_for_topic() - multiple versions'''
        schemas = []
        for v in range(1, 50):
    ...
    def test_obj_reg_regmod_reg_then_get_ver_1(self):
        '''TASRClient.get_schema_for_topic() - non-sequential re-reg'''
    ...
    def test_obj_multi_topic_reg(self):
        '''TASRClient.get_schema_for_topic() - one schema, registered for
