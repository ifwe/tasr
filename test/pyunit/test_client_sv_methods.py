...
class TestTASRClientSVMethods(TestTASRAppClient):
    ...
    def test_bare_get_subject_config(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            config_dict = tasr.client_sv.get_subject_config(self.event_type,
                                                            self.host,
                                                            self.port)
    ...
    def test_bare_update_subject_config(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            ...
            config_dict = tasr.client_sv.update_subject_config(self.event_type,
                                                               update_config,
                                                               self.host,
                                                               self.port)
    ...
    def test_bare_is_subject_integral(self):
        ...
        self.bare_register_subject_skeleton()
        with httmock.HTTMock(self.route_to_testapp):
            is_int = tasr.client_sv.is_subject_integral(self.event_type,
                                                        self.host,
                                                        self.port)
    ...
    def test_bare_get_get_all_subject_names_with_one_present(self):
        ...
        self.bare_register_subject_skeleton()
        with httmock.HTTMock(self.route_to_testapp):
            subject_names = tasr.client_sv.get_all_subject_names(self.host,
                                                                 self.port)
            self.assertListEqual(subject_names, [self.event_type, ],
                                 'unexpected groups: %s' % subject_names)
    ...
    def test_bare_get_all_subject_schema_ids(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            ...
            ids = tasr.client_sv.get_all_subject_schema_ids(self.event_type,
                                                            self.host,
                                                            self.port)
    ...
    def test_bare_get_all_subject_schemas(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            ...
            schemas = tasr.client_sv.get_all_subject_schemas(self.event_type,
                                                             self.host,
                                                             self.port)
            for v in range(1, 50):
    ...
    def test_bare_register_schema_if_latest(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            ...
            alt_schema_str = alt_schema_str.replace('tagged.events',
                                                    'tagged.alt', 1)
            cur_latest_ver = 1
            rs = tasr.client_sv.register_schema_if_latest(self.event_type,
                                                          cur_latest_ver,
                                                          alt_schema_str,
                                                          self.host,
                                                          self.port)
    ...
    def test_bare_fail_register_schema_if_latest_stale_version(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            old_ver = 1
            try:
                tasr.client_sv.register_schema_if_latest(self.event_type,
                                                         old_ver,
                                                         self.schema_str,
                                                         self.host,
                                                         self.port)
    ...
    def test_bare_lookup_by_schema_str(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            func = tasr.client_sv.lookup_by_schema_str
    ...
    def test_bare_lookup_by_sha256_id_str(self):
        ...
        with httmock.HTTMock(self.route_to_testapp):
            for v in range(1, 50):
                ...
                rs = tasr.client_sv.lookup_by_id_str(self.event_type,
                                                     sha256_id,
                                                     self.host,
                                                     self.port)
    ...
    def test_bare_lookup_latest(self):
        ...
        # so cur ver is now 2
        with httmock.HTTMock(self.route_to_testapp):
            rs = tasr.client_sv.lookup_latest(self.event_type,
                                              self.host,
                                              self.port)
