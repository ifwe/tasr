...
def get_for_topic_and_version(topic_name=None, version=None):
    ...
    if reg_schema:
        ...
        # retrieved RS.  If we asked for a version for a topic and got back an
        # RS with a differing version, it is safe to overwrite the version for
...
def get_for_id(base64_id=None):
    '''Retrieves the registered schema with the specified id.
    '''
